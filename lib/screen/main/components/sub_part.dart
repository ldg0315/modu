...
class SubPart extends StatelessWidget {
  ...
  const SubPart({Key? key, required this.mainSales}) : super(key: key);
    ...
    return StaggeredGridView.countBuilder(
        ...
        itemBuilder: (BuildContext context, int index) {
          if (index == 0) {
            ...
            return Container(
              child: Center(child: Text("이번달 매출액: ${mainSales.thisRevenue}원", style: TextStyle(fontSize: 12.5),)),
            ...
            return Container(
              child: Center(child: Text("지난달 매출액: ${mainSales.lastRevenue}원", style: TextStyle(fontSize: 12.5),)),
              decoration: const BoxDecoration(
                border: Border(
                  bottom: BorderSide(),
                ),
            ...
            return Container(
              child: Center(child: Text("미수금: ${mainSales.unpaid}원", style: TextStyle(fontSize: 12.5),)),
              decoration: const BoxDecoration(
                  border: Border(
                      bottom: BorderSide()
                  )
